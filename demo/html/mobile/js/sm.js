...
+function ($) {
    ...
    var defaults = {
        ...
        value: null,// [today.getFullYear(), formatNumber(today.getMonth() + 1), formatNumber(today.getDate()), today.getHours(), formatNumber(today.getMinutes())],
...
+function ($) {
    ...
    $.initPullToRefresh = function (pageContainer) {
        ...
        var isTouched, isMoved, touchesStart = {},
            ...
            useTranslate = false, startTranslate = 0,
        ...
        function handleTouchStart(e) {
            ...
            touchesStart.x = e.type === 'touchstart' ? x : e.pageX;
            touchesStart.y = e.type === 'touchstart' ? y : e.pageY;
...
+function ($) {
    ...
    function isInRouterBlackList($link) {
        var classBlackList = [
            'external', 'tab-link', 'open-popup',
            'close-popup', 'open-panel', 'close-panel'
        ];
